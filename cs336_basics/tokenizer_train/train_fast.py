    ...
    for _ in range(num_merges):
        ...
        for node1 in nodes_to_process:
            ...
            if node1.prev:
                ...
                heapq.heappush(pq, PQItem(pair_freqs[old_left_pair], old_left_pair,
                ...
                heapq.heappush(pq, PQItem(pair_freqs[new_left_pair], new_left_pair,
            ...
            if node2.next:
                ...
                heapq.heappush(pq, PQItem(pair_freqs[old_right_pair], old_right_pair,
                ...
                heapq.heappush(pq, PQItem(pair_freqs[new_right_pair], new_right_pair,
